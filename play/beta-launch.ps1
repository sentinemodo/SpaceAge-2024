...
Write-Host "  Local:  $GameHostUrl/client/"
Write-Host "  Public: https://manatee-sabbath-kudos.ngrok-free.dev/client/  (after .\play\expose-game-host-ngrok.ps1)"
Write-Host ""
Write-Host "GM scenarios: play/hosted-beta-gm.md"
Write-Host ""
