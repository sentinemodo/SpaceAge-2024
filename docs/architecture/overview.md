...
| **Visual tool** | `tools/visual-tool/` | React/Vite authenticated report client. [ADR-0010](adr/ADR-0010-visual-tool.md) |
...
| Source | Use for |
|--------|---------|
| `play/player/rules.md`, `docs/architecture/` | **Live behavior** |
