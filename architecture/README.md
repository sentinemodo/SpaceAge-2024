...
| `delivery/` | Branching, environments, versioning, CI entrypoints; SampleGame turn 4 checklist [`delivery/samplegame-turn4.md`](delivery/samplegame-turn4.md); campaign play plan [`delivery/campaign-play.md`](delivery/campaign-play.md) |
