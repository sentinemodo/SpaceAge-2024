...
- **Shared:** `player/rules.md`, `battle.md`, mode-specific tech manuals → `.data/shared-{test|campaign}/shared.sqlite`
...
- Verbs must appear in allowlist derived from `player/rules.md` headings
