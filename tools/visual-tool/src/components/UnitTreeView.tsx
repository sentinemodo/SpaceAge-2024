        ...
        {atLocationLevel ? (
          displayRoots.map((s) => (
            <TreeBranch
              ...
              selectedPersonId={selectedPersonId}
              factionId={factionId}
              collapsed={searching ? emptyCollapsed : collapsedStacks}
          ...
          groups?.map((g) => (
            <LocationGroup
              ...
              selectedStackId={selectedStackId}
              selectedPersonId={selectedPersonId}
              collapsedLocations={searching ? emptyCollapsed : collapsedLocations}
              collapsedStacks={searching ? emptyCollapsed : collapsedStacks}
